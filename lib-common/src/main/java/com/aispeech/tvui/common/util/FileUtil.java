...
public class FileUtil {
     ...
     * 删除文件
     * @param filePath 文件路径
     * @return {@code true}:删除文件成功 <br>{@code false}:otherwise
     */
    public static boolean deleteOldFile(final String filePath) {
        return deleteOldFile(getFileByPath(filePath));
    }
     ...
     * @return {@code true}:删除文件成功<br>{@code false}:otherwise
     */
    public static boolean deleteOldFile(final File file) {
        if (file == null){
            return false;
        }
     ...
     * 删除文件及目录
     * @param filePath 文件路径
     * @return {@code true}:删除文件及路径成功 <br>{@code false}:otherwise
     */
